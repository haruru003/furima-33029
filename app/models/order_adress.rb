class OrderAdress
  ...
  def save
    ...
    Adress.create(post_code: post_code, prefecture_code_id: prefecture_code_id, city: city, house_number: house_number, building_name: building_name, trading_record_id: order.id)
  end
end
